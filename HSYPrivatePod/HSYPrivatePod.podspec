...
TODO: Add long description of the pod here.
  ...
  s.frameworks = 'UIKit', 'MapKit','Foundation','AFNetworking', 'MBProgressHUD','FMDB','Masonry','DZNEmptyDataSet','YYKit','TZImagePickerController'
  ...
  s.dependency 'WordPress-Editor-iOS-Extension'
  s.dependency 'TZImagePickerController', '2.0.0.5'
end
