...
#pragma mark 网络请求分离  带分页请求参数 自定义POST
-(void)POST:(NSString *)URL Parameters:(id)parameters with:(RequestPageParamItem *)page Success:(HSYResponseSuccess)successBlock CodeError:(HSYResponseCodeError)codeError Failure:(HSYResponseFail)failBlock Token:(BOOL)token{
