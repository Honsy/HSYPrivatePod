...
{
    NSString *getUDIDInKeychain = (NSString *)[LZKeyChain load:kBundleIdentifier];
...
//        NSLog(@"\n \n \n _____重新存储 UUID _____\n \n \n  %@",result);
        [LZKeyChain save:kBundleIdentifier data:result];
        getUDIDInKeychain = (NSString *)[LZKeyChain load:kBundleIdentifier];
    }
